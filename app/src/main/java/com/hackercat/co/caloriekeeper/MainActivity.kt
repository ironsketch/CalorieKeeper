    ...
    fun displayStuff(){
        ...
        for(i in (arr.size - 1) downTo 0) {
            ...
            if(dateChanged) {
                ...
                tmpCalorieTotal.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryLight))
                tmpCalorieTotal.setBackgroundColor(ContextCompat.getColor(this, R.color.other))
                ...
                tmpDate.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryLight))
                tmpDate.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimary))
            ...
            tmpEntry.setBackgroundColor(ContextCompat.getColor(this, R.color.other))
            tmpEntry.setPadding(30, 0, 30, 0)

            // Onclick
            tmpEntry.setOnClickListener {
                var colorARGB = (tmpEntry.background as ColorDrawable).color
                if(colorARGB == ContextCompat.getColor(this, R.color.colorAccent)){
                    dbh.deleteEntry(arr[i][0])
                    displayStuff()
                }
                tmpEntry.setBackgroundColor(ContextCompat.getColor(this, R.color.colorAccent))
            }
            ...
            tmpFood.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryLight))
            ...
            tmpCalories.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryLight))
